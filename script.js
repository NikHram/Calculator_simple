function calculate() {
    ...
    setTimeout(() => {  document.getElementById("Prikol").innerHTML = "You broke everything!" }, 3000);
    setTimeout(() => {  document.getElementById("Prikol").innerHTML = "Never do math again." }, 5000);
}
